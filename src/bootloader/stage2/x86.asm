...
;void _cdecl x86_Disk_Read(uint8_t drive, uint16_t cylinder, uint16_t sectors,
;                           uint16_t heads, uint8_t count,
;                           uint8_t far *dataOut);
...
;void _cdecl x86_Disk_GetDriveParams(uint8_t drive, uint8_t *dataTypeOut,
